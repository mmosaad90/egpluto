$(function() {
  var url = window.location.href,
    ...
    id = '',
    li = '',
    m = 5, // الشاشة الرئيسية للتعليقات
    n = str.length,
    k = 0,
    p = 0
	$("#top-continue").removeClass("hidden");
  // استدعاء iframe عند النقر فوق زر الرد
  ...
  // اتصل بـ iframe عند النقر على زر إضافة تعليق في الأسفل
  ...
  // قم بمعالجة عنوان المتصفح إذا كان هناك رابط للتعليق
